...
public class LeastFrequentlyUsedCacheTest {
    ...
    @BeforeEach
    void setUp() {
        cache = new LeastFrequentlyUsedCache<>(storageMock, 4);
    }
    ...
    @Test
    public void testGetKeySuccess() throws ItemNotFound {
        cache.put("key1", "value1");
        String actual = cache.get("key1");
        String expected = "value1";
    ...
    @Test
    public void testGetKeyWhenTheSameKeyIsPutAgain() throws ItemNotFound {
        cache.put("key1", "value1");
    ...
    @Test
    public void testGetValuesSuccess() {
        cache.put("key1", "value1");
        cache.put("key2", "value2");
        cache.put("key3", "value3");
